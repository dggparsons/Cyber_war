...
ACTIONS: List[ActionDefinition] = [
    ActionDefinition(
        ...
        category="status_quo",
        escalation=0,
        description="Take no action this slot. Passive economic growth continues.",
        self_effects={"current_prosperity": 2},
        visibility="passive",
    ),
    ActionDefinition(
        code="SHARE_INTEL",
    ...
    ActionDefinition(
        ...
        category="posturing",
        escalation=0,
        description="Propose a mutual-defense pact. Both nations must submit Form Alliance targeting each other in the same round for it to take effect. +5 security to both sides on success.",
        target_required=True,
        self_effects=None,
        target_effects=None,
        visibility="diplomatic",
